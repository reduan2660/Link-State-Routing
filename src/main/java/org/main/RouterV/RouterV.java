package org.main.RouterV;

import org.main.util.Link;
...
public class RouterV {
    ...
    public static int port = PortMap.map.get(id); // 8001
    public static int broadcastNo = 1;
    public static int broadcastThreshold = 10; // After 5 broadcast, cost will change

    public static int[][] cost = {
            //        u    v    w    x    y    z
            /* u */ { 0 ,  2 , inf, inf, inf, inf},
            /* v */ { 2 ,  0 ,  3 ,  2 , inf, inf},
            /* w */ {inf,  3 ,  0 , inf, inf, inf},
            /* x */ {inf,  2 , inf,  0 , inf, inf},
