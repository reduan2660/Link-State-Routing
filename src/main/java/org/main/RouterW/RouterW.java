...
public class RouterW {
    ...
    public static int broadcastThreshold = 15; // After 5 broadcast, cost will change
    ...
    public static int[][] cost = {
            //        u    v    w    x    y    z
            /* u */ { 0 , inf,  5 , inf, inf, inf},
            /* v */ {inf,  0 ,  3 , inf, inf, inf},
            /* w */ { 5 ,  3 ,  0 ,  3 ,  1 ,  5 },
            /* x */ {inf, inf,  3 ,  0 , inf, inf},
            /* y */ {inf, inf,  1 , inf,  0 , inf},
            /* z */ {inf, inf,  5 , inf, inf,  0 }
    };
