...
public class RouterZ {
    ...
    public static int broadcastThreshold = 30; // After 5 broadcast, cost will change

    public static int[][] cost = {
            //        u    v    w    x    y    z
            /* u */ { 0 , inf, inf, inf, inf, inf},
            /* v */ {inf,  0 , inf, inf, inf, inf},
            /* w */ {inf, inf,  0 , inf, inf, inf},
            /* x */ {inf, inf, inf,  0 , inf, inf},
            /* y */ {inf, inf, inf, inf,  0 , inf},
            /* z */ {inf, inf, inf, inf,  2 ,  5 }
    };
