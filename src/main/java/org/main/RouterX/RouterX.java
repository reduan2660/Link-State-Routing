...
public class RouterX {
    ...
    public static int broadcastThreshold = 20; // After 5 broadcast, cost will change

    public static int[][] cost = {
            //        u    v    w    x    y    z
            /* u */ { 0 , inf, inf,  1 , inf, inf},
            /* v */ {inf,  0 , inf,  2 , inf, inf},
            /* w */ {inf, inf,  0 ,  3 , inf, inf},
            /* x */ { 1 ,  2 ,  3 ,  0 ,  1 , inf},
            /* y */ {inf, inf, inf,  1 ,  0 , inf},
